...
# AVAL COMMUNITY CR - CONFIGURACIÓN APACHE / CPANEL
# =======================================================================
...
const leemeContent = `========================================================================
AVAL COMMUNITY CR - GUÍA DE INSTALACIÓN EN CPANEL
========================================================================
...
Archivo: avalcommunity-cpanel-public_html.zip
------------------------------------------------------------------------
...
3. Sube el archivo "avalcommunity-cpanel-public_html.zip".
...
Archivo: avalcommunity-cpanel-node.zip
------------------------------------------------------------------------
...
3. Configura:
   ...
   - Application root: la carpeta donde subas el zip (ej. avalcommunity)
   - Application startup file: server.js (o app.js)
4. Sube y extrae "avalcommunity-cpanel-node.zip" en esa carpeta.
