...
import { CheckCircle2, Coins, Loader2, Search, ShieldCheck, Sparkles, Ticket } from "lucide-react";
...
export function ConsultaStickerSection() {
  ...
  return (
    <section id="consulta-stickers" className="relative mx-auto max-w-6xl px-5 py-20 border-t border-border/40 overflow-hidden">
      {/* Resplandor ambiental de fondo acorde a la estética de Aval */}
      <div className="pointer-events-none absolute -top-20 -left-20 size-72 rounded-full bg-primary/15 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-20 -right-20 size-72 rounded-full bg-amber-500/10 blur-3xl" />
      ...
      <div className="relative z-10 grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-center">
        ...
        <div className="lg:col-span-6 space-y-4">
          ...
          <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl tracking-wide uppercase leading-tight text-white">
            BUSCÁ TU <span className="text-fire">TOKEN OFICIAL</span>
          </h2>
        ...
        <div className="lg:col-span-6">
          <div className="rounded-2xl border border-border bg-[image:var(--gradient-surface)] p-6 sm:p-8 shadow-[var(--shadow-card)] relative overflow-hidden backdrop-blur-md">
            ...
            >
              ...
              <span>Número de Token / Sticker</span>
            </label>
                ...
                {resultado.ocupado ? (
                  <div className="rounded-xl border border-amber-500/40 bg-amber-500/10 p-4">
                    ...
                    <p className="mt-3 text-[11px] text-muted-foreground leading-snug">
                      🔒 Este número ya se encuentra registrado y certificado en la base de datos de Aval Community CR.
                    </p>
                  </div>
                ) : (
