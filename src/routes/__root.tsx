...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", sizes: "32x32", href: "/favicon-32x32.png?v=brand2" },
      { rel: "icon", type: "image/png", sizes: "16x16", href: "/favicon-16x16.png?v=brand2" },
      { rel: "icon", href: "/favicon.ico?v=brand2", sizes: "any" },
      { rel: "shortcut icon", href: "/favicon.ico?v=brand2" },
      { rel: "apple-touch-icon", href: "/icons/icon-192.png?v=brand2" },
      { rel: "icon", href: "/icons/icon.svg?v=brand2", type: "image/svg+xml" },
