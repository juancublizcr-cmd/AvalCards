...
export const REMATE_DEFAULT: Remate = {
  id: "remate-001",
  titulo: "Toyota Land Cruiser Prado TX-L 2026 0KM",
  subtitulo: "Adjudicado en el Gran Evento Promocional Aval · Puesto a Remate VIP por el Ganador",
  descripcion:
    "Vehículo 100% nuevo de agencia 0KM, libre de todo gravamen, con marchamo cancelado y traspaso notarial completo incluido a cargo de Aval Community CR. El ganador del sorteo original optó por monetizar el premio en nuestra sala de subastas privada.",
  imagenes: [
    "/premio-prado.jpg",
    "/prado_rear.jpg",
    "/prado_interior.jpg",
  ],
  precioSalida: 35000000,
  precioReserva: 42000000,
  ...
  ganadorSorteo: {
    ...
    declaracion:
      "Me pegué la nave con mi paquete de 8 tokens, pero ya tengo vehículo familiar. Decidí ponerla en la Sala de Remates Aval para recibir efectivo directo y permitir que otro miembro de la comunidad se la lleve a un super precio.",
  },
  vehiculoInfo: {
    marca: "Toyota",
    modelo: "Land Cruiser Prado TX-L 4x4",
    ano: 2026,
    kilometraje: "15 km (Entrega de Agencia)",
    motor: "2.8L Turbo Diesel Intercooler",
    potencia: "204 HP / 500 Nm Torque",
    transmision: "Automática Secuencial 6 Vel.",
    traccion: "4WD Full Time con Reductora",
    combustible: "Diésel",
    color: "Blanco Perla Metalizado",
    traspasoIncluido: true,
    marchamoAlDia: true,
    garantiaAgencia: "3 Años o 100,000 km Purdy Motor",
